...
const searchTypeArray = ['users', 'courses']
...
const ActiveButtonsToggle = ({
  ...
  return (
    <div className='max-w-60 m-4 mt-6 flex items-center justify-between gap-4 rounded-full bg-primary-100 p-1 opacity-75 shadow-md'>
