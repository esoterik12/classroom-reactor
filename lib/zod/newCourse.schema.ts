...
export const newCourseSchema = z.object({
  ...
  courseName: z.string().min(3, { message: "A course name is required." }),
  description: z.string().min(3, { message: "Please enter a short description of the course." }),
  createdBy: z.string()
});
